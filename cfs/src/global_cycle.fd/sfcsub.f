...
!
      ...
      IF (IRET .NE. 0) THEN
        WRITE(6,*) ' ERROR IN OPENING FILE ',trim(FNGRIB),iret
        PRINT *,'ERROR IN OPENING FILE ',trim(FNGRIB),iret
        CALL ABORT
      ENDIF
...
!cggg the grib parameter id number.
        ...
        IF (IRET .NE. 0) THEN
          WRITE(6,*) ' ERROR IN OPENING FILE ',trim(FNSNOA),iret
          PRINT *,'ERROR IN OPENING FILE ',trim(FNSNOA),iret
          CALL ABORT
        ENDIF
        LUGI=0
        lskip=-1
