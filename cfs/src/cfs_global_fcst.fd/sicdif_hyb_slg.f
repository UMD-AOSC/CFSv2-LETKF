...
!sela use akbk_hyb_def
      ...
      if (mod(l,2).eq.mod(jcap+1,2)) then
         ...
         indev2 = indlsev(jcap  ,l)
                ...
                label_hpm="sicdife_hyb_slg do 1 "
ccmr  call f_hpmstart(104,"sicdife_hyb_slg do 1 ")
      call f_hpmstart(104,label_hpm)
c$$$  do j=1,levs
...
c$$$  enddo
     ...
     &               ve(indev1,2,1), len_trie_ls*2)
      ...
      call f_hpmstop(104)
                label_hpm="sicdife_hyb_slg do 17"
ccmr  call f_hpmstart(105,"sicdife_hyb_slg do 17")
      call f_hpmstart(105,label_hpm)
      do 17 j=1,levs
   ...
   17 continue
      call f_hpmstop(105)
                label_hpm="sicdife_hyb_slg do 3 "
ccmr  call f_hpmstart(106,"sicdife_hyb_slg do 3 ")
      call f_hpmstart(106,label_hpm)
c$$$  do j=1,levs
c$$$        do indev = indev1 , indev2
c$$$           xe(indev,1,j) =0.
c$$$           xe(indev,2,j) =0.
...
c$$$  enddo
     ...
     &                  xe(indev,2,1), len_trie_ls*2)
      ...
      call f_hpmstop(106)
                label_hpm="sicdife_hyb_slg do 4 "
ccmr  call f_hpmstart(107,"sicdife_hyb_slg do 4 ")
      call f_hpmstart(107,label_hpm)
c$$$     do indev = indev1 , indev2
...
c$$$  enddo
     ...
     &                  ue(indev1,2,1), len_trie_ls*2)
      ...
      call f_hpmstop(107)
                label_hpm="sicdife_hyb_slg do 5 "
ccmr  call f_hpmstart(108,"sicdife_hyb_slg do 5 ")
      call f_hpmstart(108,label_hpm)
         do indev = indev1 , indev2
...
c$$$  enddo
     ...
     &               ue(indev1,2,1), len_trie_ls*2)
      ...
      call f_hpmstop(108)
                label_hpm="sicdife_hyb_slg do 6 "
ccmr  call f_hpmstart(109,"sicdife_hyb_slg do 6 ")
      call f_hpmstart(109,label_hpm)
      do j=1,levs
            do indev = indev1 , indev2
...
!sela use akbk_hyb_def
      ...
      if (mod(l,2).eq.mod(jcap+1,2)) then
         ...
         indod2 = indlsod(jcap+1,l)
                ...
                label_hpm="sicdifo_hyb_slg do 1 "
ccmr  call f_hpmstart(114,"sicdifo_hyb_slg do 1 ")
      call f_hpmstart(114,label_hpm)
c$$$  do j=1,levs
...
c$$$  enddo
     ...
     &               vo(indod1,2,1), len_trio_ls*2)
      ...
      call f_hpmstop(114)
                label_hpm="sicdifo_hyb_slg do 17"
ccmr  call f_hpmstart(115,"sicdifo_hyb_slg do 17")
      call f_hpmstart(115,label_hpm)
      do 17 j=1,levs
   ...
   17 continue
      call f_hpmstop(115)
                label_hpm="sicdifo_hyb_slg do 3 "
ccmr  call f_hpmstart(116,"sicdifo_hyb_slg do 3 ")
      call f_hpmstart(116,label_hpm)
c$$$  do j=1,levs
c$$$        do indod = indod1 , indod2
c$$$           xo(indod,1,j) = 0.
c$$$           xo(indod,2,j) = 0.
...
c$$$  enddo
     ...
     &                  xo(indod,2,1), len_trio_ls*2)
      ...
      call f_hpmstop(116)
                label_hpm="sicdifo_hyb_slg do 4 "
ccmr  call f_hpmstart(117,"sicdifo_hyb_slg do 4 ")
      call f_hpmstart(117,label_hpm)
c$$$     do indod = indod1 , indod2
...
c$$$  enddo
     ...
     &                  uo(indod1,2,1), len_trio_ls*2)
      ...
      call f_hpmstop(117)
                label_hpm="sicdifo_hyb_slg do 5 "
ccmr  call f_hpmstart(118,"sicdifo_hyb_slg do 5 ")
      call f_hpmstart(118,label_hpm)
         do indod = indod1, indod2
...
c$$$  enddo
     ...
     &               uo(indod1,2,1), len_trio_ls*2)
      ...
      call f_hpmstop(118)
                label_hpm="sicdifo_hyb_slg do 6 "
ccmr  call f_hpmstart(119,"sicdifo_hyb_slg do 6 ")
      call f_hpmstart(119,label_hpm)
      do j=1,levs
            do indod = indod1, indod2
