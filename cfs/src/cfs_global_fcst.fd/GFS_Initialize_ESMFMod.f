...
!
 SUBROUTINE set_lonsgg(lonsperlat,lonsperlar,num_reduce,me)
      ...
      integer lonsperlat_878(1320),lonsperlar_878(1320)
      integer lonsperlat_1278(1920),lonsperlar_1278(1920)
      integer lonsperlat_1318(1980),lonsperlar_1318(1980)
...
! T764
      ...
      if (num_reduce < 0) then
        ...
        if (jcapg .eq. 878) then
          lonsperlat=lonsperlat_878
          lonsperlar=lonsperlar_878
        endif
        if (jcapg .eq. 1278) then
          lonsperlat=lonsperlat_1278
          lonsperlar=lonsperlar_1278
        endif
        if (jcapg .eq. 1318) then
          lonsperlat=lonsperlat_1318
          lonsperlar=lonsperlar_1318
        endif
      ...
      if (jcapg .ne.  62 .and. jcapg .ne. 126 .and. jcapg .ne. 170 .and.    &
          ...
          jcapg .ne. 510 .and. jcapg .ne. 574 .and. jcapg .ne. 764 .and.    &
          jcapg .ne. 878 .and. jcapg .ne. 1278 .and. jcapg .ne. 1318) then
