      subroutine ndslfv_psm_advecth (wind,grid,tend,ddpt,dppt,
...
!     integer, parameter :: nvars=5	! u v t dp p2 tracers
      ...
      real      rma, rm2a, rdt2, rkappa, tkrt0, pi
...
! change from reduced to full grids.
        call cyclic_psm_intpx(levs,lons_lat,lonf,uulon(1,1,lan))
        call cyclic_psm_intpx(levs,lons_lat,lonf,vvlon(1,1,lan))
        call cyclic_psm_intpx(nlevs,lons_lat,lonf,qqlon(1,1,lan))
...
!
        call cyclic_psm_massadvx(lonfull,levs,nvars,deltim,               &
...
!
        ...
        call cyclic_psm_massadvy(latfull,levs,nvars,deltim,
...
!
        call cyclic_psm_intpx(nlevs,lonf,lons_lat,qqlon(1,1,lan))
