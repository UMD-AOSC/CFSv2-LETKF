...
!   2010-02-17  Shrinivas Moorthi - removed "use resol_def" and added ngrids_nst!                                   to the argument
!
! Public Variables:
...
!-------------------------------------------------------------------------------
  subroutine nstio_swhead(lu,head,ngrids_nst,iret)
    implicit none
    integer(nstio_intkind),intent(in):: lu, ngrids_nst
...
!-------------------------------------------------------------------------------
  subroutine nstio_swohdca(lu,cfname,head,ngrids_nst,data,iret)
    implicit none
    integer(nstio_intkind),intent(in):: lu
    character*(*),intent(in):: cfname
    type(nstio_head),intent(in):: head
    integer(nstio_intkind),intent(in):: ngrids_nst
    type(nstio_data),intent(in):: data
    integer(nstio_intkind),intent(out):: iret
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    if(iret.ne.0) return
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    call nstio_swhead(lu,head,ngrids_nst,iret)
    if(iret.ne.0) return
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
!-------------------------------------------------------------------------------
  subroutine nstio_swohdcb(lu,cfname,head,ngrids_nst,dbta,iret)
    implicit none
    integer(nstio_intkind),intent(in):: lu
    character*(*),intent(in):: cfname
    type(nstio_head),intent(in):: head
