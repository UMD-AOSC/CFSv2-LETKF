...
!
      if(icolor.eq.2.and.me.eq.nodes-1) buff1=data%xt
      call split2d(buff1, buffo,global_lats_r)
      CALL interpred(1,kmsk,buffo,nst_fld%xt,
     &               global_lats_r,lonsperlar)

      if(icolor.eq.2.and.me.eq.nodes-1) buff1=data%xs
      call split2d(buff1, buffo,global_lats_r)
      CALL interpred(1,kmsk,buffo,nst_fld%xs,
     &               global_lats_r,lonsperlar)

      if(icolor.eq.2.and.me.eq.nodes-1) buff1=data%xu
      call split2d(buff1, buffo,global_lats_r)
      CALL interpred(1,kmsk,buffo,nst_fld%xu,
     &               global_lats_r,lonsperlar)

      if(icolor.eq.2.and.me.eq.nodes-1) buff1=data%xv
      call split2d(buff1, buffo,global_lats_r)
      CALL interpred(1,kmsk,buffo,nst_fld%xv,
     &               global_lats_r,lonsperlar)

      if(icolor.eq.2.and.me.eq.nodes-1) buff1=data%xz
      call split2d(buff1, buffo,global_lats_r)
      CALL interpred(1,kmsk,buffo,nst_fld%xz,
     &               global_lats_r,lonsperlar)

      if(icolor.eq.2.and.me.eq.nodes-1) buff1=data%zm
      call split2d(buff1, buffo,global_lats_r)
      CALL interpred(1,kmsk,buffo,nst_fld%zm,
     &               global_lats_r,lonsperlar)

      if(icolor.eq.2.and.me.eq.nodes-1) buff1=data%xtts
      call split2d(buff1, buffo,global_lats_r)
      CALL interpred(1,kmsk,buffo,nst_fld%xtts,
     &               global_lats_r,lonsperlar)

      if(icolor.eq.2.and.me.eq.nodes-1) buff1=data%xzts
      call split2d(buff1, buffo,global_lats_r)
     ...
     &               global_lats_r,lonsperlar)
      ...
      if(icolor.eq.2.and.me.eq.nodes-1) buff1=data%d_conv
      call split2d(buff1, buffo,global_lats_r)
     ...
     &               global_lats_r,lonsperlar)
      ...
      if(icolor.eq.2.and.me.eq.nodes-1) buff1=data%Qrain
      call split2d(buff1, buffo,global_lats_r)
