...
!
      ...
      if (mod(l,2).eq.mod(jcap+1,2)) then
         ...
         indev2 = indlsev(jcap  ,l)
                ...
                label_hpm="impadje_slg do 1 "
ccmr  call f_hpmstart(121,"impadje_slg do 1 ")
      call f_hpmstart(121,label_hpm)
c$$$  do k=1,levs
...
c$$$  enddo
     ...
     &         snnp1ev(indev)*(ve(indev,2,k)+tor_slg(k)*ze(indev,2))
      ...
      enddo
      call f_hpmstop(121)
                label_hpm="impadje_slg do 2 "
ccmr  call f_hpmstart(122,"impadje_slg do 2 ")
      call f_hpmstart(122,label_hpm)
c$$$  do k=1,levs
c$$$      do indev = indev1 , indev2
c$$$        ve(indev,1,k)=cons0     !constant
c$$$        ve(indev,2,k)=cons0     !constant
...
c$$$  enddo
     ...
     &                  ve(indev,2,1), len_trie_ls*2)
      ...
      call f_hpmstop(122)
                label_hpm="impadje_slg do 3 "
ccmr  call f_hpmstart(123,"impadje_slg do 3 ")
      call f_hpmstart(123,label_hpm)
c$$$  do j=1,levs
c$$$    do indev = indev1 , indev2
...
c$$$  enddo
     ...
     &                  qe(indev1,2), len_trie_ls*2)
        ...
        enddo
      call f_hpmstop(123)
                label_hpm="impadje_slg do 4 "
ccmr  call f_hpmstart(124,"impadje_slg do 4 ")
      call f_hpmstart(124,label_hpm)
c$$$  do k=1,levs
c$$$    do j=1,levs
c$$$      do indev = indev1 , indev2
...
!
      ...
      if (mod(l,2).eq.mod(jcap+1,2)) then
         ...
         indod2 = indlsod(jcap+1,l)
                ...
                label_hpm="impadjo_slg do 1 "
ccmr  call f_hpmstart(125,"impadjo_slg do 1 ")
      call f_hpmstart(125,label_hpm)
c$$$  do k=1,levs
...
c$$$  enddo
     ...
     &         snnp1od(indod)*(vo(indod,2,k)+tor_slg(k)*zo(indod,2))
      ...
      enddo
      call f_hpmstop(125)
                label_hpm="impadjo_slg do 2 "
ccmr  call f_hpmstart(126,"impadjo_slg do 2 ")
      call f_hpmstart(126,label_hpm)
c$$$  do k=1,levs
c$$$      do indod = indod1 , indod2
c$$$        vo(indod,1,k)=cons0     !constant
c$$$        vo(indod,2,k)=cons0     !constant
...
c$$$  enddo
     ...
     &                  vo(indod,2,1), len_trio_ls*2)
      ...
      call f_hpmstop(126)
                label_hpm="impadjo_slg do 3 "
ccmr  call f_hpmstart(127,"impadjo_slg do 3 ")
      call f_hpmstart(127,label_hpm)
c$$$  do j=1,levs
c$$$    do indod = indod1 , indod2
...
c$$$  enddo
     ...
     &                  qo(indod1,2), len_trio_ls*2)
        ...
        enddo
      call f_hpmstop(127)
                label_hpm="impadjo_slg do 4 "
ccmr  call f_hpmstart(128,"impadjo_slg do 4 ")
      call f_hpmstart(128,label_hpm)
c$$$  do k=1,levs
c$$$    do j=1,levs
c$$$      do indod = indod1 , indod2
