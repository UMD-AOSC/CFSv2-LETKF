...
export LIB="../../lib/libbufr_v10.2.3_4_64.a"
if [ $OS = "AIX" ]
then
...
export LIB="../../lib/libbufr_v10.2.3_8_64.a"
if [ $OS = "AIX" ]
then
...
export LIB="../../lib/libbufr_v10.2.3_d_64.a"
if [ $OS = "AIX" ]
then
...
export LIB="../../lib/libbufr_v10.2.3_s_64.a"
if [ $OS = "AIX" ]
then
    export FFLAGS=" -O4 -q64 -qsource -qstrict -qnosave -qintsize=4 -qrealsize=4 -qxlf77=leadzero"
    export CFLAGS=" -O3 -q64"
...
then
    ...
    export CFLAGS=" -O3 -mcmodel=medium -DUNDERSCORE"
    export AFLAGS=" "
fi
make -f make.libbufr
err_make=$?
...
if [ -s ../../lib/libbufr_v10.2.3_s_64.a ] ; then
   echo
